...
/**
 * Floating "Send feedback" affordance, shown app-wide for signed-in users.
 * Captures the current route + role + company so trial friction is actionable.
 * Writes to kaizen_feedback (RLS: insert-own; Top Management reads its company's).
 */
